...
export const adviceTranslations: Record<string, T4> = {
  // ── Prévenir ──
  "adv.prev.title": { fr: "Se protéger des arnaques", en: "How to protect yourself from scams", fon: "Nɛ̌ è ka sixú hɛn éɖée sín gblègblé lɛ̌ sí gbɔn?", yo: "Báwo ni o ṣe lè dáàbòbò ara rẹ lọ́wọ́ jìbìtì?" },
  "adv.prev.subtitle": { fr: "Les bons réflexes au quotidien pour ne pas tomber dans le piège.", en: "Good daily habits to avoid falling into the trap.", fon: "Nǔ ɖagbe e è na wà gbèbígbèbí bo ma jɛ mɔ̌ mɛ ǎ é.", yo: "Àṣà rere láti ní lójoojúmọ́ kí o má bàa wọ ìdẹ̀kùn." },
  ...
  "adv.prev.1.d": { fr: "Ne donnez jamais votre code PIN, OTP ou Mobile Money. Aucune banque ni opérateur ne vous les demandera par téléphone.", en: "Never share your PIN, OTP, or Mobile Money code. No bank or operator will ever ask for them by phone.", fon: "Kóɖú PIN, kóɖú OTP, kóɖú Mobile Money... Bánkì ɖé ɔ́ opérateur ɖé kún na byɔ́ nǔ élɔ́ lɛ̌ we gbɔn telefónu alǒ SMS gblamɛ gbeɖé ó.", yo: "Koodu PIN, ọ̀rọ̀ aṣínà, koodu OTP, koodu Mobile Money... Ko sí báńkì tàbí olùpèsè tó máa béèrè àwọn ìwífún wọ̀nyí lọ́wọ́ rẹ nípasẹ̀ fóònù tàbí SMS." },
  ...
  "adv.prev.2.d": { fr: "Si un inconnu appelle et raccroche aussitôt, ne rappelez pas. C'est un numéro surtaxé conçu pour vous faire payer.", en: "If an unknown caller hangs up right away, don't call back. It's a premium-rate trap designed to charge you.", fon: "Nú wěmánúmɛ e a ma tuun ǎ é ylɔ́ we bó sɔ́ telefónu ɔ d'ayǐ tlóló ɔ, ma lɛ́ ylɔ́ ɛ ó. Mɔ̌ wɛ̀ bo na xò akwɛ́ towe.", yo: "Tí nọ́mbà tí o kò mọ̀ bá pe ẹ́ tí ó sì gbé fóònù lẹ́sẹ̀kẹsẹ̀, má pe padà. Ìdẹ̀kùn ni láti gba owó rẹ." },
  "adv.prev.3.t": { fr: "Méfiez-vous des liens suspects", en: "Don't click suspicious links", fon: "Ma zín lien e ma sɔgbe ǎ lɛ̌ wu ó", yo: "Má tẹ àwọn ìjápọ̀ afurasi" },
  "adv.prev.3.d": { fr: "Ne cliquez jamais sur un lien reçu par SMS. Tapez l'adresse du site officiel vous-même.", en: "Never click a link received by SMS. Type the official website address yourself.", fon: "SMS ɖé ɖɔ a ɖu nǔ, kɔ̌li towe ɖò ayǐ alǒ è na sɔ́ akwɛ́ lɛ̌kɔ na we? Ma zín wu gbeɖé ó. Yi tɛn ɔ jɛ̌jɛ̌ bó wlán adɔ̌rɛ́sù ɔ hwiɖesunɔ.", yo: "SMS tó sọ pé o ṣẹ́gun, pàásẹ̀lì dí tàbí ìsanpadà? Má tẹ̀ẹ́ rí. Lọ taara sí ojú-ìwé aṣẹ náà kí o sì tẹ àdírẹ́sì náà fúnra rẹ." },
  "adv.prev.4.t": { fr: "Vérifiez l'identité de votre interlocuteur", en: "Verify who you're talking to", fon: "Kpɔ́n mɛ e ɖò xó ɖɔ nú we wɛ̌ é dó gaàn", yo: "Ṣàyẹ̀wò ẹni tó ń bá ẹ sọ̀rọ̀" },
  "adv.prev.4.d": { fr: "Raccrochez et appelez vous-même le numéro officiel. Ne faites jamais confiance à un appel entrant.", en: "Hang up and call the official number yourself. Never trust an incoming call.", fon: "Mɛɖé ɖɔ émi wɛ̀ nyí bánkì towe, MTN, Moov? Sɔ́ telefónu ɔ d'ayǐ bó ylɔ́ wěmánúmɛ tótɔ́ ɔ hwiɖesunɔ.", yo: "Ẹnìkan sọ pé òun wá láti ọ̀dọ̀ báńkì rẹ, MTN, Moov? Gbé fóònù kí o sì pe nọ́mbà aṣẹ fúnra rẹ." },
  "adv.prev.5.t": { fr: "Méfiez-vous des offres trop belles", en: "Beware of too-good offers", fon: "Cɔ́ hwiɖée dó nǔ e nyɔ́ hú agbɔ̌n lɛ̌ wu", yo: "Ṣọ́ra fún àwọn ipèsè tó dára jù" },
  "adv.prev.5.d": { fr: "Si c'est trop beau pour être vrai, c'est une arnaque. Aucune loterie ne contacte ses gagnants par SMS.", en: "If it sounds too good to be true, it's a scam. No lottery contacts winners by SMS.", fon: "\"A ɖu loto miliɔ́ɔ̌n 5\", \"Dǒ akwɛ́ towe jí azɔn wè ɖò ganxixo 24 mɛ\"... Nú é nyɔ́ hú agbɔ̌n ɔ, gblègblé wɛ̀. Loto ɖé kún nɔ sɛ̀ xó dó nú mɛ gbɔn SMS gblamɛ ó.", yo: "\"O ṣẹ́gun mílíọ̀nù 5\", \"Ṣe owó rẹ ní ìlọ́po méjì ní wákàtí 24\"... Tí ó bá dára jù, jìbìtì ni. Ko sí lottery tó máa kàn sí olùborí nípasẹ̀ SMS." },
  "adv.prev.6.t": { fr: "Parlez-en autour de vous", en: "Warn those around you", fon: "Ðɔ nú mɛ e lɛ̀ li we lɛ̌", yo: "Sọ fún àwọn tó wà ní àyíká rẹ" },
  "adv.prev.6.d": { fr: "Sensibilisez vos proches, surtout les aînés et les jeunes. Les arnaqueurs ciblent les personnes isolées.", en: "Warn your loved ones, especially the elderly and young. Scammers target isolated people.", fon: "Dǒ nǔ kplɔ́n mɛ vívɔ́ towe lɛ̌, taji mɛxomɔ lɛ̌ kpó yɔ̌vǐ lɛ̌ kpó. Gblègblétɔ́ lɛ̌ nɔ ba mɛ e ɖò éɖokpónɔ lɛ̌.", yo: "Jẹ́ kí àwọn ẹbí rẹ mọ̀, pàápàá àgbàlagbà àti ọ̀dọ́. Àwọn olójúkòkòrò máa ń wá àwọn tó dá wà tàbí tí kò ní ìwífún." },
  ...
  "adv.prev.7.d": { fr: "Les arnaqueurs créent de faux profils séduisants pour obtenir vos photos. Ils s'en servent ensuite pour vous faire chanter.", en: "Scammers create fake attractive profiles to get your photos. They then use them to blackmail you.", fon: "Ké mɛ e a ɖeji dó wu bó mɔ ɖò ɛntɛnɛ́ti jí é ɔ nɛ̀. Gblègblétɔ́ lɛ̌ nɔ bló profil yǎyi bo na mɔ ɖiɖe towe lɛ̌, bó nɔ dó xɛ̌si we (sextorsion).", yo: "Kódà sí ẹni tí o gbẹ́kẹ̀lé tí o pàdé lórí ayélujára. Àwọn olójúkòkòrò máa ń dá profaili èké ẹlẹ́wà láti gba àwòrán rẹ, lẹ́yìn náà wọ́n á halẹ̀ mọ́ ẹ (sextorsion)." },
  "adv.prev.8.t": { fr: "Refusez les appels vidéo inconnus", en: "Disable your camera with strangers", fon: "Sú kaméra towe nú mɛ e a ma tuun ǎ lɛ̌", yo: "Pa kámẹ́rà rẹ fún àwọn àjèjì" },
  "adv.prev.8.d": { fr: "Refusez les appels vidéo avec des inconnus. Ils enregistrent votre image pour créer des montages compromettants.", en: "Refuse video calls from people you don't know. They record you to create compromising footage.", fon: "Ma yí gbè nú vidéo ylɔ̌ylɔ́ xá mɛ e a ma tuun ɖò gbɛmɛ ǎ é gbeɖé ó. Gblègblétɔ́ lɛ̌ nɔ wlí ɖiɖe towe bo nɔ bló nǔ nyanya.", yo: "Má gba ìpè fídíò lọ́wọ́ ẹni tí o kò mọ̀ ní ojúko. Àwọn olójúkòkòrò máa ń ya àwòrán rẹ láti ṣe àdàkọ èké." },

  // ── Reconnaître ──
  "adv.reco.title": { fr: "Reconnaître une arnaque", en: "How to recognize a scam", fon: "Nɛ̌ è ka sixú dǒ gblègblé ɖé nukún gbɔn?", yo: "Báwo ni o ṣe lè mọ jìbìtì?" },
  "adv.reco.subtitle": { fr: "Les signaux qui doivent vous alerter immédiatement.", en: "Warning signs that should alert you right away.", fon: "Wuntun ayi tɔn e ɖó na ɖó ayi towe wu tlóló lɛ̌.", yo: "Àwọn àmì ìkìlọ̀ tó gbọ́dọ̀ mú ẹ ṣọ́ra lẹ́sẹ̀kẹsẹ̀." },
  "adv.reco.1.t": { fr: "La fausse urgence", en: "Fake urgency", fon: "Kàn e ma nyí tɔn ǎ é", yo: "Ìpayà èké" },
  "adv.reco.1.d": { fr: "Les arnaqueurs vous pressent exprès pour vous empêcher de réfléchir. Prenez le temps de vérifier avant d'agir.", en: "Scammers rush you on purpose so you can't think. Take time to verify before acting.", fon: "\"A ɖó na sú dìn\", \"Kɔ́ntì towe na sú ɖò ganxixo 1 mɛ\"... Gblègblétɔ́ lɛ̌ nɔ bló bonu nǔ na yá bó ma na lin tamɛ ǎ.", yo: "\"O gbọ́dọ̀ san báyìí\", \"Àkáǹtì rẹ yóò dí ní wákàtí 1\"... Àwọn olójúkòkòrò máa ń dá ìpayà kí o má lè ronú." },
  "adv.reco.2.t": { fr: "Les gains inattendus", en: "Unexpected winnings", fon: "Nǔɖuɖu e è ma ɖó nukún tɔn ǎ lɛ̌", yo: "Èrè àìròtẹ́lẹ̀" },
  "adv.reco.2.d": { fr: "Vous n'avez jamais participé mais vous avez « gagné » ? Si l'on vous demande des frais pour récupérer votre gain, c'est une arnaque.", en: "You never entered, yet you \"won\"? If they ask for fees to claim your prize, it's a scam.", fon: "A ma ɖó alɔ ɖò loto ɖé mɛ ǎ amɔ̌ a \"ɖu\"? È byɔ́ we ɖɔ a ni sú \"akwɛ́ dɔ̌syé tɔn\"? Gblègblé wɛ̀ hwebǐnu.", yo: "O kò forúkọsílẹ̀ fún eré kankan ṣùgbọ́n o \"ṣẹ́gun\"? Wọ́n béèrè pé kí o san \"owó iṣẹ́\"? Jìbìtì ni nígbà gbogbo." },
  "adv.reco.3.t": { fr: "L'appel aux sentiments", en: "Emotional manipulation", fon: "Ayixa sísɔ́", yo: "Ìfọkànbalẹ̀ èké" },
  "adv.reco.3.d": { fr: "Un proche en danger a besoin d'argent d'urgence ? Appelez-le directement sur son vrai numéro avant d'envoyer quoi que ce soit.", en: "A loved one needs urgent money? Call them directly on their real number before sending anything.", fon: "Mɛ vívɔ́ towe ɖò \"axɔ\" mɛ bó ɖó hudo akwɛ́ tɔn tlóló? Ylɔ́ mɛ ɔ ɖesunɔ dó wěmánúmɛ tɔn tɔn jí hwɛ̌ cobɔ a na sɛ́ nǔɖé dó.", yo: "Ẹbí rẹ kan wà nínú \"ewu\" tó nílò owó ní kíákíá? Ṣàyẹ̀wò nípa pípe ẹni náà taara lórí nọ́mbà gidi rẹ̀ kí o tó fi ohunkóhun ránṣẹ́." },
  "adv.reco.4.t": { fr: "L'usurpation d'autorité", en: "Authority impersonation", fon: "Mɛ e nɔ wà mɛ ɖěvo sín nǔ lɛ̌", yo: "Dídá ẹni aláṣẹ" },
  "adv.reco.4.d": { fr: "Faux policier, faux agent de banque... Les arnaqueurs se font passer pour des autorités pour vous intimider. Ne cédez pas.", en: "Fake police, fake bank manager... Scammers pose as authorities to intimidate you. Don't give in.", fon: "Polisíe-nyijɛ́, agent takwɛ́-nyijɛ́, bánkì gǎn-nyijɛ́... Gblègblétɔ́ lɛ̌ nɔ wà acɛkpikpa sín nǔ bo na dó xɛ̌si we.", yo: "Ọlọ́pàá èké, aṣojú owó-orí èké, alámòjúlò báńkì èké... Àwọn olójúkòkòrò máa ń ṣe bí ẹni aláṣẹ láti dẹ́rù bá ẹ." },
  ...
  "adv.reco.5.d": { fr: "On vous demande d'envoyer de l'argent pour « débloquer » un service ? N'envoyez rien, c'est une arnaque.", en: "Asked to send money to \"unlock\" a service? Send nothing — it's a scam.", fon: "È byɔ́ we ɖɔ a ni sɛ́ akwɛ́ dó gbɔn MTN MoMo alǒ Moov Money gblamɛ bo na \"hun\" nǔsúsú, kɔ̌li alǒ azɔ̌ ɖé? Ma sɛ́ nǔɖé dó ó.", yo: "Wọ́n béèrè pé kí o fi owó ránṣẹ́ nípasẹ̀ MTN MoMo tàbí Moov Money láti \"ṣí\" owó, pàásẹ̀lì tàbí iṣẹ́? Má fi ohunkóhun ránṣẹ́." },
  ...
  "adv.reco.6.d": { fr: "« Je me suis trompé, renvoyez-moi l'argent » ? Vérifiez d'abord votre solde réel. Le SMS de confirmation peut être falsifié.", en: "\"I sent to the wrong number, please return the money\"? Check your real balance first. Confirmation SMS can be faked.", fon: "\"Un wɔ̀n ɖé, lɛ̌ sɛ́ akwɛ́ ɔ wá nú mì\" : kpɔ́n akwɛ́ e ɖò kɔ́ntì towe mɛ nugbǒ é hwɛ̌. SMS yíyí tɔn ɔ sixú nyí nyijɛ́.", yo: "\"Mo ṣàṣìṣe nọ́mbà, fi owó náà padà ránṣẹ́\" : ṣàyẹ̀wò iye owó gidi rẹ kí ó tó pé ohunkóhun. SMS gbígba lè jẹ́ èké." },
  "adv.reco.7.t": { fr: "Le chantage à l'intime", en: "Sextortion / intimate blackmail", fon: "Sextorsion / xɛ̌sidíd xó nǔhɛnmɛ tɔn", yo: "Sextortion / ìhalẹ̀mọ́ni ìkọ̀kọ̀" },
  "adv.reco.7.d": { fr: "Un inconnu séduisant vous contacte et pousse vers des échanges intimes. Puis vient le chantage : « Paye ou je diffuse tes photos. »", en: "An attractive stranger contacts you and pushes toward intimate exchanges. Then comes the threat: \"Pay or I share your photos.\"", fon: "Mɛ e a ma tuun ǎ bɔ é nyɔ́ é ylɔ́ we, bɔ nǔ lɛ̌ sù tawun yì nǔhɛnmɛ tɔn. Enɛ̌ gudo ɔ, xɛ̌si lɛ̌ wá: \"Sú akwɛ́ alǒ un na ɖè ɖiɖe towe tɔ́n nú xwédo towe.\"", yo: "Àjèjì ẹlẹ́wà kan kàn sí ẹ, ìbáṣepọ̀ náà yára dé ipele ìkọ̀kọ̀. Lẹ́yìn náà ìhalẹ̀mọ́ni dé: \"San owó bí bẹ́ẹ̀ kọ́ èmi yóò fi àwòrán rẹ hàn fún ẹbí rẹ.\"" },
  "adv.reco.8.t": { fr: "L'arnaque aux sentiments", en: "Romance scam", fon: "Gblègblé wǎn tɔn (romance scam)", yo: "Jìbìtì ìfẹ́ (romance scam)" },
  "adv.reco.8.d": { fr: "Une relation amoureuse en ligne, jamais rencontrée en vrai. Après des semaines de séduction, on vous demande de l'argent pour une « urgence ».", en: "A romantic relationship online with someone you've never met. After weeks of charm, they ask for money for an \"emergency\".", fon: "Wǎnyíyí ɖò ɛntɛnɛ́ti jí xá mɛ e a ma mɔ gbeɖé ǎ é. Aklunɔzán wè gudo ɔ, é byɔ́ akwɛ́ dó \"tikɛ́ti zɔ̌nlin\" alǒ \"azɔn kàn\" wu.", yo: "Ìbáṣepọ̀ ìfẹ́ lórí ayélujára pẹ̀lú ẹni tí o kò tíì rí ní ojúko. Lẹ́yìn ọ̀sẹ̀ púpọ̀, wọ́n béèrè owó fún \"tikẹ́ẹ̀tì ọkọ̀ òfurufú\", \"pàjáwírì ìlera\"..." },

  // ── Réagir ──
  "adv.react.title": { fr: "Que faire si vous êtes victime", en: "What to do if you're a victim", fon: "Nǔ e è na wà nú gblègblé xò we ɔ", yo: "Ohun tí o lè ṣe bí o bá jẹ́ olùjìyà" },
  "adv.react.subtitle": { fr: "Agissez vite si vous avez été arnaqué.", en: "Act fast if you've been scammed.", fon: "Afɔ e è na ɖè lɛ̌ tlóló nú gblègblé xò we ɔ.", yo: "Àwọn ìgbésẹ̀ láti tẹ̀lé lẹ́sẹ̀kẹsẹ̀ bí wọ́n bá ti jí ẹ lólè." },
  "adv.react.1.t": { fr: "Gardez votre calme", en: "Stay calm", fon: "Nɔ fífá mɛ", yo: "Farabalẹ̀" },
  "adv.react.1.d": { fr: "Ne paniquez pas. Agissez vite mais calmement, et notez tout ce dont vous vous souvenez.", en: "Don't panic. Act quickly but calmly, and write down everything you remember.", fon: "Ma ɖò adǎn jí ó. Nú a wà nǔ yá bó lin tamɛ ɔ, a na ɖó acɛ d'é jí hugǎn. Wlán nǔ e a flín lɛ̌ bǐ.", yo: "Má páyà. Bí o ṣe yára tó sì ronú, bẹ́ẹ̀ ni àǹfààní rẹ ṣe pọ̀ tó láti dín àìdá kù. Kọ ohun gbogbo tí o rántí sílẹ̀." },
