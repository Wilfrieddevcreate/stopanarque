...
export const metadata: Metadata = pageMetadata({
  ...
  type: "article",
  ogDescription:
    "Guide complet anti-arnaques au Bénin : prévenir, reconnaître, réagir.",
  keywords: ["conseils anti-arnaque Bénin", "se protéger des arnaques", "que faire victime arnaque Bénin", "reconnaître une arnaque", "numéro OCRC Bénin", "prévention cybercriminalité Bénin", "sécurité Mobile Money"],
});
